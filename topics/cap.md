The CAP Theorem (also called Brewer’s Theorem) is a fundamental principle in distributed systems that explains the trade-offs between Consistency, Availability, and Partition Tolerance.
